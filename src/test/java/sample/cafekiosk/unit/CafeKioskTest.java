...
//        assertThat(order.getBeverages().get(0).getName()).isEqualTo("아메리카노");
    ...
    void creatOrderWithCurrentTime() {
        ...
        Order order = cafeKiosk.creatOrder(LocalDateTime.of(2025, 3, 13, 10, 0));
        assertThat(order.getBeverages()).hasSize(1);
        assertThat(order.getBeverages().get(0).getName()).isEqualTo("아메리카노");
    ...
    void creatOrderOutsideOpenTime() {
        ...
        assertThatThrownBy(() -> cafeKiosk.creatOrder(LocalDateTime.of(2025, 3, 13, 9, 59)))
